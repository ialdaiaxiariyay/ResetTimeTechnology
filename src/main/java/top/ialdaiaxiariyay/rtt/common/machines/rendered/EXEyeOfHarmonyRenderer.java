package top.ialdaiaxiariyay.rtt.common.machines.rendered;
...
public class EXEyeOfHarmonyRenderer extends WorkableCasingMachineRenderer implements IControllerRenderer {
    ...
    public EXEyeOfHarmonyRenderer() {
        super(GTLCore.id("block/casings/dimensionally_transcendent_casing"), GTCEu.id("block/multiblock/cosmos_simulation"));
    }
    ...
    public void render(BlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer,
        ...
        if (blockEntity instanceof IMachineBlockEntity machineBlockEntity &&
                machineBlockEntity.getMetaMachine() instanceof EXHarmonyMachine machine && machine.isActive()) {
