...
import static top.ialdaiaxiariyay.rtt.common.items.RTTItem.*;
import static top.ialdaiaxiariyay.rtt.common.machines.recipes.RTTRecipeTypes.*;

public class CustomRecipe {

    public static void init(Consumer<FinishedRecipe> provider) {
        if (RTTConfigHolder.INSTANCE.EnableDeepvioletgleamAndCircuitRecipe) {
            VanillaRecipeHelper.addShapedRecipe(provider, true, "glimmer_lv_processor_mainfram",
                    ...
                    "AAA",
                    'A', Tags.Items.SAND,
                    'B', new UnificationEntry(TagPrefix.gem, RTTMaterials.DeepvioletGleam));
            ...
            LARGE_SHAPE_WORLD_VOID_PUMP.recipeBuilder("deepvioletgleam_1")
                    .circuitMeta(2)
                    .outputFluids(RTTMaterials.DeepvioletGleam.getFluid(1296))
                    .duration(500)
                    .EUt(GTValues.VA[GTValues.LuV])
                    .save(provider);

        }
        if (RTTConfigHolder.INSTANCE.EnableTheGeneralSteamEngine) {
            VanillaRecipeHelper.addShapedRecipe(provider, true, "the_general_steam_engine",
                    RTTMachines.THE_GENERAL_STEAM_ENGINE.asStack(),
                    "ABA",
                    "BCB",
                    "ABA",
                    'A', GetRegistries.getItem("gtceu:steam_machine_casing"),
                    'B', GetRegistries.getItem("rtt:void_world_block"),
                    'C', GetRegistries.getItem("kubejs:precision_steam_mechanism"));
        }
        if (RTTConfigHolder.INSTANCE.EnableFreeAe) {

            VanillaRecipeHelper.addShapedRecipe(provider, true, "general_ae_production",
                    RTTMachines.GENERAL_AE_PRODUCTION.asStack(),
                    "AAA",
                    "ABA",
                    "AAA",
            ...
            EXTRACTOR_RECIPES.recipeBuilder("rtt_fluid_fluix")
                    ...
                    .outputFluids(RTTMaterials.FluixCrystal.getFluid(144))
                    .duration(200)
            ...
            GENERAL_AE_PRODUCTION.recipeBuilder("rtt_ae2_fluix_cable_1")
                    ...
                    .inputFluids(RTTMaterials.FluixCrystal.getFluid(144))
